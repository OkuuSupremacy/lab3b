package com.example.lab3b_razin;
...
public class FoodList extends AppCompatActivity {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    dialog.dismiss();
                    Toast.makeText(getApplicationContext(), "Update successfully!!!", Toast.LENGTH_SHORT);
                }
    ...
    private void showDialogDelete(final int idFood) {
        ...
        dialogDelete.setMessage("Are you sure you want to perform this deletion?");
